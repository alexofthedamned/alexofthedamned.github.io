...
int main() {
	...
	if (number_of_checks <= 19) {
		...
		fee = 19 * 0.10; //for first 19 checks
		fee = fee + number_of_checks * 0.08;
	}
	else if (number_of_checks > 39 and number_of_checks <= 59) {
		fee = 20 * 0.08 + 19 * 0.1; //for first 39 checks
		fee = fee + number_of_checks * 0.06;
	}
	else {
		fee = 20 * 0.06 + 20 * 0.08 + 19 * 0.1; //for first 59 checks
		fee = fee + number_of_checks * 0.04;
	}
